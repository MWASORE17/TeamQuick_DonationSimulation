...
public class QuickDonateActivity extends ParentActivity {
    Data data;
    private User user;
    private EditText et_jlhdonasi, et_password;
    private Button btnquickdonasi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = Data.datas.get(Data.datas.size()-1);
        ...
        final TextView donateDompet = (TextView) findViewById(R.id.activity_quick_donate_dompet);
        donateDompet.setText(String.valueOf(user.getDompet()));
        TextView title = (TextView) findViewById(R.id.activity_quick_donate_judul);
        title.setText(data.getJudul());


        et_jlhdonasi= (EditText)findViewById(R.id.activity_quick_donate_jumlah);
        et_password = (EditText)findViewById(R.id.activity_quick_donate_password);

        containerjumlah = (TextInputLayout)findViewById(R.id.activity_quick_donate_jumlah_container);
        containerpassword = (TextInputLayout)findViewById(R.id.activity_quick_donate_password_container);

        btnquickdonasi = (Button)findViewById(R.id.activity_quick_donate_button);

        btnquickdonasi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if(et_jlhdonasi.getText().toString().length()==0){
                    ...
                    Intent _intent = new Intent(QuickDonateActivity.this,PrintActivity.class);
                    _intent.putExtra("data",data);
                    _intent.putExtra("jumlah",jumlah);
                    Toast.makeText(QuickDonateActivity.this,"Berhasil",Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.logout:
                ...
                break;
            case R.id.quick:
                Intent quick = new Intent(QuickDonateActivity.this, QuickDonateActivity.class);
                startActivity(quick);
                finish();
                break;
            case R.id.tambah:
                Intent dompet = new Intent(QuickDonateActivity.this, Dompet.class);
