            ...
            public void onClick(View view) {
                ...
                */
                if (TextUtils.isEmpty(email.getText())) {
                    ...
                    emailcontainer.setError("Email masih kosong");
                } else if (!AuthActivity.isemailvalid(email.getText().toString())) {
                    _isvalid = false;
                    emailcontainer.setErrorEnabled(true);
                    emailcontainer.setError("Email salah");
                } else if (TextUtils.isEmpty(password.getText())) {
                    _isvalid = false;
                    passwordcontainer.setErrorEnabled(true);
                    passwordcontainer.setError("Password masih kosong");
                }
                ...
                */
                if (_isvalid) {
                    ...
                    if (!_isregistered) {
                        ...
                        passwordcontainer.setErrorEnabled(true);
                        passwordcontainer.setError("Password salah");
                    }

                    if (_isregistered && _ismatch) {
                        SessionManager.with(getContext()).createsessionuser(_user);
